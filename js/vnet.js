...
/*******************/
    ...
    $( document ).ready(function() {
        var hClass = $('li.nav-item').hasClass('active');
        console.log(hClass);
        if(hClass){
            $('.store-menu.fix-position').css({"background-color":"#edd001","position":"relative"});
            $('.fix-nav').css({"background-color":"#edd001","position":"relative","padding-bottom":"15px","padding-top":"15px"})
        }
    });
